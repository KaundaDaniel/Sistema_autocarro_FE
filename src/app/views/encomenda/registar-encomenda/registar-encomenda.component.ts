...
@Component({
  selector: 'app-registar-encomenda',
  templateUrl: './registar-encomenda.component.html',
  styleUrls: ['./registar-encomenda.component.css']
})
export class RegistarEncomendaComponent implements OnInit {
  ...
  public selectBoxPayment() {
    this.encomendaService.selectBoxPayment()
      .subscribe(response => {
  ...
  finishOrder() {
    ...
    this.encomendaService.finishOrder(payload_order)
      .subscribe(response => {
